...
public class RecyclerView_Config3 {
    ...
    private RecyclerView_Config3.CreditAdapter mCreditAdapter;
    public void setConfig(RecyclerView recyclerView, Context context, List<BadHistory> credits1, List<String> keys){
        mContext = context;
        mCreditAdapter = new RecyclerView_Config3.CreditAdapter(credits1,keys);
    ...
    class CreditItemView extends RecyclerView.ViewHolder {
        ...
        public void bind(final BadHistory credit, String key){
    ...
    class CreditAdapter extends RecyclerView.Adapter<RecyclerView_Config3.CreditItemView>{

        private List<BadHistory> mCreditList;
        private List<String> mKeys;

        public CreditAdapter(List<BadHistory> mCreditList, List<String> mKeys) {
        ...
        @NonNull
        @Override
        public RecyclerView_Config3.CreditItemView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new RecyclerView_Config3.CreditItemView(parent);
        }

        @Override
        public void onBindViewHolder(@NonNull RecyclerView_Config3.CreditItemView holder, int position) {
