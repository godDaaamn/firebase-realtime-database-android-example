...
public class WithoutPercent {
    private String comission,first,img_link,link,rating_link,repeated,time;

    public WithoutPercent() {
    }

    public WithoutPercent(String comission, String first, String img_link, String link, String rating_link, String repeated, String time) {
